        ...
        return BaseController.extend("sap.kt.com.minihrsolution.controller.AssetAssignment", {
            ...
            _onRouteMatched: async function (oEvent) {
                ...
                if (this._fromRoute === "IncomeAsset") {
                    oButton.setIcon("sap-icon://nav-back");  // back icon
                } else {
                    oButton.setIcon("sap-icon://home");      // default home icon
                }
            ...
            AA_onDownload: function () {
                ...
                const oSettings = {
                    workbook: {
                        columns: aCols,
                        context: {
                            sheetName: that.i18nModel.getText("assetAssignment")
                        },
            ...
            AA_onPressAssign: async function () {
                ...
                if (!this.FAA_Dialog) {
                    ...
                    this.FAA_Dialog = sap.ui.core.Fragment.load({
                        ...
                        if (this.oLoginModel.getProperty("/Role") === "IT Consultant" || this.oLoginModel.getProperty("/Role") === "IT Manager" || this.oLoginModel.getProperty("/Role") === "Admin") {
            ...
            AA_onOpenUnassign: function () {
                ...
                if (oTableSelected) {
                    ...
                    if (oBindingContext) {
                        ...
                        sap.ui.getCore().byId("FAU_id_unassignDate").setDateValue(new Date());
                    } else {
                        this.closeBusyDialog();
