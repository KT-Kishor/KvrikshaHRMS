        ...
        return BaseController.extend(
            "sap.kt.com.minihrsolution.controller.CreditNote", {
                ...
                onInit: function() {
                 ...
                 _onRouteMatched: async function(oEvent) {
                    try {
                        ...
                        (FileName !== "CreditNote") ? this._isClearPressed = true : this._isClearPressed = false
                ...
                CI_onPressDownload: function() {
                    ...
                    const aCols = [{
                            label: this.i18nModel.getText("creditMemoNo"),
                            property: "CCInvNo",
                            type: "string"
                        },
                        {
                    ...
                    const oSettings = {
                        workbook: {
                            columns: aCols,
                            context: {
                                sheetName: this.i18nModel.getText("CreditNote")
                            }
                        },
